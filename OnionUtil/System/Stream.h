...
namespace onion::system
{
	...
	public:
		...
		inline virtual void operator<<(const float& value) = 0;
		inline virtual void operator<<(const double& value) = 0;
		 //wstring
		...
		inline virtual void operator>>(float* value) = 0;
		inline virtual void operator>>(double* value) = 0;
		 //wstring											
